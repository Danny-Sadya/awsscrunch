...
#        service = Service('/usr/local/bin/chromedriver')
    ...
    def run(self):
        ...
        try:
            ...
            keys = results[0].keys()
            with open(f'Result{self.shift}.csv', 'w', newline='', encoding='utf-8') as output_file:
    ...
    def authenticate(self):
        try:
            ...
            pass
        self.paste_text(xpath='//input[@class="MuiInputBase-input MuiInput-input"]', value='dannysadya@gmail.com')
...
if __name__ == "__main__":
    scraper = ScrunchScraper(shift=0)
    results = scraper.run()
